...
const itemId = (id) => carts.value.findIndex((item) => {
            ...
            <div class="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
                                    ...
                                    <div>
                                        <input
                                            v-model="carts[itemId(product.id)].quantity"
                                             id="first_product" class="bg-gray-50 w-14 text-center ml-3 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block px-2.5 py-1 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"  placeholder="1" required />
                                    </div>
                ...
                <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
                    ...
                    <div v-if="userAddress">
                        ...
                        <p class="leading-relaxed mb-5 text-gray-600">{{userAddress.address1}} -> {{userAddress.state}}/{{userAddress.city}}</p>
                        <p class="leading-relaxed mb-5 text-gray-600">Or You can add new below</p>
                    </div>
                    <div v-else>
                        <p class="leading-relaxed mb-5 text-gray-600">Add shopping address to continue</p>
                    </div>
                    ...
                    <form @submit.prevent="submit()" >
                        ...
                        <div class="relative mb-4">
                            ...
                            <input type="text" id="email" name="country_code"  v-model="form.country_code"
                                   class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                        </div>
                        <div class="relative mb-4">
